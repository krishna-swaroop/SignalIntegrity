...
DeviceList=Devices([
                ...
                DeviceIdealBalun(),
                DeviceReference(),
                DeviceVoltageStatisticalNoiseSource([PartPropertyDescription('One Port Voltage Statistical Noise Generator'),PartPropertyPorts(1),PartPropertyMode('single-ended')],PartPictureVariableVoltageSourceNoiseSourceOnePort()),
                DeviceVoltageStatisticalNoiseSource([PartPropertyDescription('Two Port Voltage Statistical Noise Generator'),PartPropertyPorts(2),PartPropertyMode('single-ended')],PartPictureVariableVoltageSourceNoiseSourceTwoPort()),
                DeviceVoltageStatisticalNoiseSource([PartPropertyDescription('Differential Voltage Statistical Noise Generator'),PartPropertyPorts(4),PartPropertyMode('differential-mode')],PartPictureVariableDifferentialNoiseSource()),
                DeviceVoltageStatisticalNoiseSource([PartPropertyDescription('Common-mode Voltage Statistical Noise Generator'),PartPropertyPorts(4),PartPropertyMode('common-mode')],PartPictureVariableDifferentialNoiseSource()),
                DeviceVoltageStatisticalNoiseSourceProject([PartPropertyDescription('One Port Voltage Statistical Noise Generator Project'),PartPropertyPorts(1),PartPropertyMode('single-ended')],PartPictureVariableVoltageSourceNoiseSourceOnePort()),
                DeviceVoltageStatisticalNoiseSourceProject([PartPropertyDescription('Two Port Voltage Statistical Noise Generator Project'),PartPropertyPorts(2),PartPropertyMode('single-ended')],PartPictureVariableVoltageSourceNoiseSourceTwoPort()),
                DeviceVoltageStatisticalNoiseSourceProject([PartPropertyDescription('Differential Voltage Statistical Noise Generator Project'),PartPropertyPorts(4),PartPropertyMode('differential-mode')],PartPictureVariableDifferentialNoiseSource()),
                DeviceVoltageStatisticalNoiseSourceProject([PartPropertyDescription('Common-mode Voltage Statistical Noise Generator Project'),PartPropertyPorts(4),PartPropertyMode('common-mode')],PartPictureVariableDifferentialNoiseSource()),
                DeviceCurrentStatisticalNoiseSource([PartPropertyDescription('One Port Current Statistical Noise Generator'),PartPropertyPorts(1),PartPropertyMode('single-ended')],PartPictureVariableCurrentSourceNoiseSourceOnePort()),
                DeviceCurrentStatisticalNoiseSource([PartPropertyDescription('Two Port Current Statistical Noise Generator'),PartPropertyPorts(2),PartPropertyMode('single-ended')],PartPictureVariableCurrentSourceNoiseSourceTwoPort()),
                DeviceCurrentStatisticalNoiseSource([PartPropertyDescription('Differential Current Statistical Noise Generator'),PartPropertyPorts(4),PartPropertyMode('differential-mode')],PartPictureVariableDifferentialCurrentNoiseSource()),
                DeviceCurrentStatisticalNoiseSource([PartPropertyDescription('Common-mode Current Statistical Noise Generator'),PartPropertyPorts(4),PartPropertyMode('common-mode')],PartPictureVariableDifferentialCurrentNoiseSource()),
                DeviceCurrentStatisticalNoiseSourceProject([PartPropertyDescription('One Port Current Statistical Noise Generator Project'),PartPropertyPorts(1),PartPropertyMode('single-ended')],PartPictureVariableCurrentSourceNoiseSourceOnePort()),
                DeviceCurrentStatisticalNoiseSourceProject([PartPropertyDescription('Two Port Current Statistical Noise Generator Project'),PartPropertyPorts(2),PartPropertyMode('single-ended')],PartPictureVariableCurrentSourceNoiseSourceTwoPort()),
                DeviceCurrentStatisticalNoiseSourceProject([PartPropertyDescription('Differential Current Statistical Noise Generator Project'),PartPropertyPorts(4),PartPropertyMode('differential-mode')],PartPictureVariableDifferentialCurrentNoiseSource()),
                DeviceCurrentStatisticalNoiseSourceProject([PartPropertyDescription('Common-mode Current Statistical Noise Generator Project'),PartPropertyPorts(4),PartPropertyMode('common-mode')],PartPictureVariableDifferentialCurrentNoiseSource()),])
