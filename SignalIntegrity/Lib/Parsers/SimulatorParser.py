...
class SimulatorParser(SystemDescriptionParser):
    ...
    def _ProcessSimulatorLine(self,line):
        ...
        - 'voltagesource' or 'networkanalyzerport' or 'voltagenoisesource' - addition of a voltage source.
        - 'currentsource' or 'currentnoisesource' - addition of a current source.
